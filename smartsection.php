...
$i++;
	...
	$result = $xoopsDB -> query("ALTER TABLE " . $xoopsDB -> prefix('impression_cat') . " CHANGE categoryid cid int(11) unsigned NOT NULL default '' auto_increment");
	$result = $xoopsDB -> query("ALTER TABLE " . $xoopsDB -> prefix('impression_cat') . " CHANGE parentid pid int(11) unsigned NOT NULL default '0'");
	$result = $xoopsDB -> query("ALTER TABLE " . $xoopsDB -> prefix('impression_cat') . " CHANGE image imgurl varchar(255) NOT NULL default ''");
	...
	//Delete some Fields
	$result = $xoopsDB -> query("ALTER TABLE " . $xoopsDB -> prefix('impression_cat') . " DROP created");
	$result = $xoopsDB -> query("ALTER TABLE " . $xoopsDB -> prefix('impression_cat') . " DROP template");
	$result = $xoopsDB -> query("ALTER TABLE " . $xoopsDB -> prefix('impression_cat') . " DROP header");
	...
	$result = $xoopsDB -> query("ALTER TABLE " . $xoopsDB -> prefix('impression_articles') . " CHANGE itemid aid int(11) unsigned NOT NULL default '' auto_increment");
...
//        $time = time();
        ...
        //Delete some Fields
        $result = $xoopsDB -> queryF("ALTER TABLE " . $xoopsDB -> prefix('impression_articles') . " DROP INDEX display_summary");
        $result = $xoopsDB -> queryF("ALTER TABLE " . $xoopsDB -> prefix('impression_articles') . " DROP INDEX dohtml");
        $result = $xoopsDB -> queryF("ALTER TABLE " . $xoopsDB -> prefix('impression_articles') . " DROP INDEX dosmiley");
        $result = $xoopsDB -> queryF("ALTER TABLE " . $xoopsDB -> prefix('impression_articles') . " DROP INDEX doxcode");
        $result = $xoopsDB -> queryF("ALTER TABLE " . $xoopsDB -> prefix('impression_articles') . " DROP INDEX doimage");
        $result = $xoopsDB -> queryF("ALTER TABLE " . $xoopsDB -> prefix('impression_articles') . " DROP INDEX partial_view");





//   echo "<b>Finish updating Module</b>\n";
