...
define( "_AM_IMPRESSION_DISABLEHTML", " erlaube HTML-Tags" );
define( "_AM_IMPRESSION_DISABLESMILEY", " erlaube Smilieicons" );
define( "_AM_IMPRESSION_DISABLEXCODE", " erlaube ImpressCMS-Code" );
define( "_AM_IMPRESSION_DISABLEIMAGES", " erlaube Bilder" );
...
define( "_AM_IMPRESSION_IPAGE_CHEADING", "Indexkopfzeile:" );
define( "_AM_IMPRESSION_IPAGE_CHEADINGA", "Indexkopfausrichtung:" );
define( "_AM_IMPRESSION_IPAGE_CFOOTER", "Indexfußzeile:" );
...
define( "_AM_IMPRESSION_ARTICLE_OFF", "AUS" );
define( "_AM_IMPRESSION_ARTICLE_ON", "AN" );
...
define( "_AM_IMPRESSION_ARTICLE_INTROTEXT", "einleitender Beitragstext:" );
...
define( "_AM_IMPRESSION_ARTICLE_DESCRIPTION", "Beitragshaupttext:" );
...
define( "_AM_IMPRESSION_ARTICLE_CATEGORY", "Hauptkategorie:" );
define( "_AM_IMPRESSION_ARTICLE_FILESSTATUS", "setze Beitragsstatus:" );
define( "_AM_IMPRESSION_ARTICLE_FILESSTATUS_DSC", "Setze Beitrag auf veröffentlicht/unveröffentlicht/abgewiesen" );
...
define( "_AM_IMPRESSION_ARTICLE_PUBLISHER", "Name des Autors:" );
// About defines
...
define( "_AM_IMPRESSION_KEYWORDS_NOTE", "Schlüsselwörter sollten durch ein Komma getrennt werden <br />(<i>Stichwort 1, Stichwort 2, Stichworte 3, etc.</i>)" );
...
define( '_AM_IMPRESSION_RSSFEEDCFG', 'RSS Feed Konfiguration' );
define( '_AM_IMPRESSION_RSSFEEDDSC', 'Hier kannst du die RSS Feed für Impression konfigurieren.<br />Für weitere Informationen Besuche die <a href="http://www.rssboard.org/" target="_blank">RSS Advisory Board</a> website.' );
define( '_AM_IMPRESSION_RSSACTIVE', 'RSS Feed Einschalten' );
define( '_AM_IMPRESSION_RSSACTIVEDSC', 'Wähle <em>Ja</em> um die RSS feed für Impression einzuschalten, Wähle <em>Nein</em> um diese auszuschalten.' );
define( '_AM_IMPRESSION_RSSTITLE', 'RSS Feed Titel' );
define( '_AM_IMPRESSION_RSSTITLEDSC', 'Der Name des Kanals. So können andere deinen Service nutzen. Wenn du eine Website hast, welche die gleichen Informationen enthält wie dein RSS-file, sollte der Titel deines Kanals der gleiche sein wie der Titel deiner Website.' );
define( '_AM_IMPRESSION_RSSLINKS', 'RSS Feed link' );
define( '_AM_IMPRESSION_RSSLINKSDSC', 'Die URL zu der Website welche mit dem Kanal zusammenarbeitet.' );
define( '_AM_IMPRESSION_RSSDESCRIPTION', 'RSS Feed Beschreibung' );
define( '_AM_IMPRESSION_RSSDESCRIPTIONDSC', 'Beschreibung des Kanals.' );
define( '_AM_IMPRESSION_RSSIMAGE', 'RSS Feed Bild' );
define( '_AM_IMPRESSION_RSSIMAGEDSC', 'Wähle ein GIF-, JPEG- oder PNG-Bild, welches mit dem Kanal angezeigt wird.' );
define( '_AM_IMPRESSION_RSSWIDTH', 'RSS Feed Bildbreite' );
define( '_AM_IMPRESSION_RSSWIDTHDSC', 'Gib die Bildbreite des RSS feed Bildes in pixel an.<br />Maximale Breite ist 144.' );
define( '_AM_IMPRESSION_RSSHEIGHT', 'RSS Feed Bildhöhe' );
define( '_AM_IMPRESSION_RSSHEIGHTDSC', 'Gib die Bildhöhe des RSS feed Bildes in pixel an.<br />Maximale Höhe ist 400.' );
define( '_AM_IMPRESSION_RSSIMGTITLE', 'RSS Feed Bildtitel' );
define( '_AM_IMPRESSION_RSSIMGTITLEDSC', 'Beschreibt das Bild, das wird genutzt für das ALT Attribut des HTML &#60;img&#62; tag der Kanal in HTML übertragen ist.' );
define( '_AM_IMPRESSION_RSSIMGLINK', 'RSS Feed Bildlink' );
define( '_AM_IMPRESSION_RSSIMGLINKDSC', 'Das ist die URL zu dem Bild-link. Wenn der Kanal übertragen wird, Ist das Bild ein Link zu der Seite. (Beachte, in der Praxis sollten das Bild &#60;title&#62; und &#60;link&#62; den gleichen Wert haben wie die Kanäle &#60;title&#62; und &#60;link&#62;).' );
define( '_AM_IMPRESSION_RSSTTL', 'RSS feed ttl' );
define( '_AM_IMPRESSION_RSSTTLDSC', 'ttl steht für time to live. Das ist die Anzahl an Minuten, die der Kanal im Cache bleibt, bevor er aktualisiert wird.' );
define( '_AM_IMPRESSION_RSSWEBMASTER', 'RSS Feed Webmaster' );
define( '_AM_IMPRESSION_RSSWEBMASTERDSC', 'Email-Adresse für den Ansprechpartner bei technischen Schwierigkeiten.' );
define( '_AM_IMPRESSION_RSSEDITOR', 'RSS feed channel editor' );
define( '_AM_IMPRESSION_RSSEDITORDSC', 'Email-Adresse für den Ansprechpartner des hinzugefügten content.' );
define( '_AM_IMPRESSION_RSSCATEGORY', 'RSS Feed Kategorie' );
define( '_AM_IMPRESSION_RSSCATEGORYDSC', 'Lege eine oder mehr Kategorien fest, zu welchen der Kanal gehört. Folgt den gleichen Regeln wie &#60;item&#62;-level category element.' );
define( '_AM_IMPRESSION_RSSGENERATOR', 'RSS feed generator' );
define( '_AM_IMPRESSION_RSSGENERATORDSC', 'Gibt das Programm wieder, welches zum generieren des Kanals genutzt wird.' );
define( '_AM_IMPRESSION_RSSCOPYRIGHT', 'RSS Feed copyright' );
define( '_AM_IMPRESSION_RSSCOPYRIGHTDSC', 'Copyright - Informationen zum Content in dem Kanal.' );
define( '_AM_IMPRESSION_RSSTOTAL', 'RSS Feed Artikelanzahl' );
define( '_AM_IMPRESSION_RSSTOTALDSC', 'Geben Sie die Anzahl der Artikel an, die im RSS Feed angezeigt werden sollen.' );
define( '_AM_IMPRESSION_RSSDBUPDATED', 'Datenbank wurde erfolgreich aktualisiert' );
define( '_AM_IMPRESSION_RSSOFFLINE', 'RSS Feed offline Nachricht - Titel' );
define( '_AM_IMPRESSION_RSSOFFLINEDSC', 'Geben Sie den Titel der Nachricht ein, wenn der RSS Feed ausgeschaltet ist.' );
define( '_AM_IMPRESSION_RSSOFFMSG', 'RSS Feed offline Nachricht' );
define( '_AM_IMPRESSION_RSSOFFMSGDSC', 'Geben Sie den Grund ein, warum der RSS Feed ausgeschaltet wurde.' );
define( '_AM_IMPRESSION_RSSOFFTITLE', 'RSS Feed wurde deaktiviert.' );
define( '_AM_IMPRESSION_RSSOFFMSGDEF', 'Der RSS Feed wurde vorübergehend für Wartungsarbeiten ausgeschaltet.' );
define( '_AM_IMPRESSION_RSSCLICKSUBMIT', 'Bitte klicken Sie auf Absenden, um alle Werte aus der Form in die Datenbank zu schreiben!' );
define( '_AM_IMPRESSION_COPYRIGHT', 'Copyright' );
define( '_AM_IMPRESSION_ICO_CLONE', 'Artikel klonen' );
define( '_AM_IMPRESSION_CLONE', '**KLONEN**' );
define( '_AM_IMPRESSION_CLONEARTICLE', 'Artikel klonen' );
define( '_AM_IMPRESSION_SHOWNOIMAGE' , 'Zeige kein Bild' );
define( '_AM_IMPRESSION_NOSELECTION', 'Nichts gewählt' );
define( '_AM_IMPRESSION_NOFILESELECT', 'Keine Datei gewählt' );
define( '_AM_IMPRESSION_PRUNE', 'Löschen' );
define( '_AM_IMPRESSION_PRUNEINFO', 'Informationen für das löschen' );
define( '_AM_IMPRESSION_PRUNEWARN', 'Hier hast du die Möglichkeit, alle Artikel zu löschen, welche vor dem gewählten Datum veröffentlicht wurden.<br />Ebenso werden kommentare zu diesem Artikel gelöscht<br />Bitte beachte: Diese Aktion kann <strong>NICHT</strong> rückgängig gemacht werden! Mache aus diesem Grund am Besten erst ein Backup der Datenbank.' );
define( '_AM_IMPRESSION_PRUNEDELETED', 'Artikel wurden erfolgreich gelöscht!' );
define( '_AM_IMPRESSION_PRUNEDATE', 'Datum wählen:' );
define( '_AM_IMPRESSION_PRUNEDATEDSC', 'Alle Artikel vor dem gewählten Datum werden gelöscht.' );
define( '_AM_IMPRESSION_PRUNEFORM', 'Lösche alte Artikel' );
define( '_AM_IMPRESSION_NICEURL', 'Alternativer Title für die URL:' );
define( '_AM_IMPRESSION_NICEURLDSC', 'Gin einen alternativen Titel für die URL ein. Wenn du die Option <em>Nutze schöne URLs</em> in den Einstellungen gewählt hast und dieses Feld leer bleibt, wird der Titel des Artikels genommen.' );
define( '_AM_IMPRESSION_ARTICLE_INBLOCKS', 'Zeige Artikel in blocks?' );
define( '_AM_IMPRESSION_ARTICLE_INBLOCKS_DSC', 'Wähle <em>Ja</em> um den Artikel im Spotlight- und Recent-Headlines-Block anzuzeigen. Wenn du <em>Nein</em> wählst, wird der Artikel nicht in den beiden Blocks angezeigt.' );
define( '_AM_IMPRESSION_MOD_INTROTEXT', 'Introduction text:' );

define( '_AM_IMPRESSION_CAT_INBLOCKS', 'Zeige Kategorie in Blöcken an?' );
