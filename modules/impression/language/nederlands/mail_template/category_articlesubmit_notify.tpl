...
Een nieuw artikel "{ARTICLE_NAME}" is ingezonden voor de categorie "{CATEGORY_NAME}" op {X_SITENAME} en wacht op goedkeuring.

Je kan het ingezonden artikel hier zien (deze pagina laat alle wachtende artikelen zien in ALLE categorieën):
{WAITINGFILES_URL}
