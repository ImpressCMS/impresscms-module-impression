...
define( '_MI_IMPRESSION_TEXTWIDTH', 'Establezca el ancho de las cajas de texto para la administración del módulo:' );
define( '_MI_IMPRESSION_TEXTWIDTHDSC', 'Las mismas se aplicarán en los formularios para añadir contenido. El tamaño predeterminado es 128.' );

define( '_MI_IMPRESSION_SOCIALBTTNS', 'Mostrar botones Social Media' );
define( '_MI_IMPRESSION_SOCIALBTTNSDSC', 'Seleccione si desea mostrar Social Bookmarks (estilo tradicional), botones de Social Media normales u otros con selección de privacidad (sólo en Alemania). Si selecciona <i>Social Share Privacy</i> the type of button is not taken into account.' );
define( '_IM_IMPRESSION_SOCBOOK', 'Marcadores sociales' );
define( '_IM_IMPRESSION_SOCMEDIA', 'Social Media' );
define( '_IM_IMPRESSION_SOCMEDIAPRIVE', 'Privacidad de Social Share' );
define( '_MI_IMPRESSION_DEFAULT', 'Predeterminado' );
define( '_MI_IMPRESSION_HORICNT', 'Contador horizontal' );
define( '_MI_IMPRESSION_VERTCNT', 'Contador vertical' );
define( '_MI_IMPRESSION_TWITTER', 'Twitter' );
define( '_MI_IMPRESSION_TWEET', 'Tweet' );
define( '_MI_IMPRESSION_TWITTERBTTN', 'Botón de Twitter' );
define( '_MI_IMPRESSION_TWITTERBTTNDSC', 'Elija un estilo para el botón de Twitter.' );
define( '_MI_IMPRESSION_FACEBOOKBTTN', 'Botón "Me gusta" de Facebook' );
define( '_MI_IMPRESSION_FACEBOOKBTTNDSC', 'Elija un estilo para el botón de Facebook.' );
define( '_MI_IMPRESSION_PLUSONEBTTN', 'Botón de Google +1' );
define( '_MI_IMPRESSION_PLUSONEBTTNDSC', 'Elija un estilo para el botón de Google +1.' );
?>