...
if ( !defined( 'DEFAULT_PATH' ) ) { define( "DEFAULT_PATH", XOOPS_UPLOAD_URL . "/blank.gif" ); }

class impressionThumbsNails {
	...
	*/
	function impressionThumbsNails( $img_name = null, $img_path = null, $img_savepath = null ) {
