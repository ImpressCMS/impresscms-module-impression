...
define( '_MB_IMPRESSION_SELECTFEED_DSC', '<small><br /><br /> - Select ICMS to use ImpressCMS RSS feed.<br /> - Select RSSfit to use Brandycoke\'s RSSfit module (subfeed needs to be activated).</small>'  );
